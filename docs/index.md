...
- [Install and usage](install.md): install commands, version selection,
  pyroSAR checks, and troubleshooting.
...
- [Maintainer guide](maintainer-guide.md): build numbers, local builds,
  publishing, and Pages setup.
